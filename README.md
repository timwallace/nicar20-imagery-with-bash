...
Dependencies: [FFmpeg](https://www.ffmpeg.org/), [GDAL](https://gdal.org/) [(👈cheat sheet)](https://github.com/dwtkns/gdal-cheat-sheet), [Gifsicle](https://www.lcdf.org/gifsicle/), [ImageMagick](https://imagemagick.org/index.php)
